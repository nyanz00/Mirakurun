...
import { ConfigChannels, ConfigChannelsItem, ChannelType, ChannelScanStatus, TunerDevice } from "../../../api.d";
...
export const ChannelsConfigView: React.FC = () => {
    ...
    const [scanMinCh, setScanMinCh] = useState("0");
    const [scanMaxCh, setScanMaxCh] = useState("52");
