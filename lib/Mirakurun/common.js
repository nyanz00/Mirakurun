...
exports.deepClone = exports.channelTypes = exports.grAltChannelTypes = void 0;
exports.isGRChannelType = isGRChannelType;
exports.getTuningChannelType = getTuningChannelType;
...
exports.grAltChannelTypes = Array.from({ length: 20 }, (_, i) => `GR-ALT${i + 1}`);
exports.channelTypes = ["GR", ...exports.grAltChannelTypes, "BS", "CS", "SKY"];
function isGRChannelType(type) {
    return type === "GR" || exports.grAltChannelTypes.includes(type);
}
function getTuningChannelType(type) {
