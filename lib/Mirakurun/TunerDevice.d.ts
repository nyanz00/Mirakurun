...
export default class TunerDevice extends EventEmitter {
    private _index;
    private _config;
    private static readonly REMOTE_SERVICES_CACHE_TTL;
    private _channel;
    private _command;
    private _process;
    private _stream;
    private _remoteServicesCache;
    private _users;
    ...
    getRemoteLogoImage(serviceId: apid.ServiceItemId): Promise<Buffer>;
    hasRemoteLogoData(serviceId: apid.ServiceItemId): Promise<boolean>;
    getRemoteServices(): Promise<apid.Service[]>;
    private _spawn;
